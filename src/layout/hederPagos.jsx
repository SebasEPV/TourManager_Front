...
export default function hederPagos({ setTitle }) {
    ...
    return (
        <hederPagos className="w-full h-16 bg-gradient-to-r from-[#4C2816] to-[#7C5E41] text-white flex items-center px-6 justify-between shadow-md">
