...
const ReservationCard = ({ reservations, loading, error }) => {
  ...
  const handleCloseModal = () => {
    ...
    setSelectedReservation(null);  // Limpiamos la reserva seleccionada
  };
          ...
          >
            ...
            <div className="p-4 flex flex-col flex-grow justify-between">
              ...
              <div className="flex justify-between gap-4">
                <button
                  onClick={() => handleOpenModal(reservation)}  // Pasamos la reserva aquí
                ...
                <button
                  onClick={() => console.log("Cancelar Reserva", reservation.id)}
