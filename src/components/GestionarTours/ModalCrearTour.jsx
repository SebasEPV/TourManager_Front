...
const ModalCrearTour = ({ onClose }) => {
    ...
    const validate = () => {
        ...
        if (!formData.actividades.trim()) newErrors.actividades = "Las actividades son obligatorias.";
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-[#E3E3E3] p-6 rounded-lg shadow-lg w-[320px] relative">
                ...
                <h2 className="text-xl font-bold mb-4 text-center">Crear Tour</h2>
                ...
                <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col">
                        <label className="font-semibold bg-[#6C8361] text-white px-2 py-1 rounded">Actividades del tour:</label>
                        <textarea className="border p-2 rounded" name="actividades" value={formData.actividades} onChange={handleChange} />
                        {errors.actividades && <p className="text-red-500 text-sm">{errors.actividades}</p>}
                    </div>
